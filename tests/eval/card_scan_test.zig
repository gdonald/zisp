//! Reaching a young object through the card a store marked.
//!
//! `tests/lisp/card-scan.lisp` holds the checks: each one signals an
...
const corpus_path = "tests/lisp/card-scan.lisp";
...
test "every check in the card scan corpus holds" {
