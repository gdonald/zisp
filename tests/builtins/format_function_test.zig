...
//! with running one.
//!
//! `tests/lisp/format-function.lisp` holds the checks: each one signals an
...
const corpus_path = "tests/lisp/format-function.lisp";
...
test "every check in the format function corpus holds" {
